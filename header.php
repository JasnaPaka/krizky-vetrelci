...
<head>
  ...
  <link rel="icon" href="<?php bloginfo('template_url') ?>-child-krizkyavetrelci/favicon.ico" type="image/x-icon" />
...
<body> 
  <div id="header" <?php if (isProjectPage()) printf('style="background-color: %s; background-image: url(\'%s\')"', $project_color, $project_background) ?>>
    <div id="header-top"> 
      <div id="blacked">
        <div class="inner">       
			<div id="logos">
